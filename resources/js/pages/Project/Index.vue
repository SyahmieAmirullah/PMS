        ...
        <BaseCard>
            <div class="mb-6 flex items-center justify-between">
                ...
                <Button @click="addProject"
                    ><Plus class="h-4 w-4" />Add Project</Button
                >
            </div>
            ...
            >
                ...
                <div
                    v-if="hasSearched && activeFiltersCount > 0"
                ...
                >
                    ...
                    >
                        Status: {{ formatStatus(formCarian.ProjectSTATUS) }}
                        <span class="ml-1">×</span>
                    </Button>
                    ...
                    <Button
                        variant="ghost"
                        size="sm"
                        class="h-7 text-xs text-red-600 hover:bg-red-50 hover:text-red-700"
                        @click="resetForm"
                    >
                        Clear All
                    </Button>
            ...
            <!-- Table -->
            <div
                class="my-3 rounded-2xl border border-gray-100 bg-white p-4 shadow-sm"
            >
                ...
                <div class="mt-4 flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        >
                            ...
                            <span v-else class="px-2 text-sm text-gray-500"
                                >…</span
                            >
                        </template>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            associated data including tasks, phases, and
                            feedback.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
            ...
            <Dialog v-model:open="showEditDialog">
                <DialogContent
                    class="dialog-content max-h-[90vh] max-w-2xl overflow-y-auto"
                >
                    <DialogHeader>
                        <DialogTitle>Edit Project</DialogTitle>
                        <DialogDescription
                            >Update project information</DialogDescription
                        >
                    </DialogHeader>
